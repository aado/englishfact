...
$sql="SELECT tblTeacher.StuID,tblTeacher.ID as sid,tblTeacher.TeacherName,tblTeacher.TeacherEmail,tblTeacher.DateofAdmission,tblclass.ClassName,tblclass.Section from tblTeacher join tblclass on tblclass.ID=tblTeacher.TeacherClass LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
                          ...
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-Teacher-detail.php?editid=<?php echo htmlentities ($row->sid);?>"><i class="icon-eye"></i></a>
                                                || <a href="manage-Teachers.php?delid=<?php echo ($row->sid);?>" onclick="return confirm('Do you really want to Delete ?');"> <i class="icon-trash"></i></a></div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
                      </table>

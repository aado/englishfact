...
$sql="insert into tblTeacher(TeacherName,TeacherEmail,TeacherClass,Gender,DOB,StuID,FatherName,MotherName,ContactNumber,AltenateNumber,Address,UserName,Password,Image)values(:stuname,:stuemail,:stuclass,:gender,:dob,:stuid,:fname,:mname,:connum,:altconnum,:address,:uname,:password,:image)";
...
<html lang="en">
  <head>
    ...
    <title>Englishfact|| Add Teachers</title>
    <!-- plugins:css -->

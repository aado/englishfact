...
<html>
<head>
<title>Englishfact || Home Page</title>
...
<div class="slider" style="margin-left: 36px;">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          <span style="color: red;font-family: revert;font-weight: bold;font-size: 25px;">Student Management</span>      
...
{               ?>
		<h2><img src="images/ourstory.jpg" style="width: 20%"><?php // echo htmlentities($row->PageTitle);?></h2>
